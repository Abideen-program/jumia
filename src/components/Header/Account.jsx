...
const wrapperClass = clx(
  "absolute -bottom-52 right-44 bg-white w-[220px] rounded-md border border-stone-500"
);
const buttonClass = clx(
  "w-full bg-[#FF9900] rounded-md text-white px-3 py-2 hover:bg-[#E07E1B] shadow-md"
);
const pclasses = clx(
  "flex items-center p-3 gap-3 hover:bg-[#f1f1f2] transition-all duration-[300]  cursor-pointer"
);
...
const Account = () => {
  return (
    <div className={wrapperClass}>
      ...
      <div className="group border-t-2 border-[#f1f1f2] mt-2 ">
