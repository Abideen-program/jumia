...
const SecondSection = () => {
  return (
    <div className="py-5 px-[55px] bg-[#535357] text-white flex flex-col item md:flex-row justify-between">
      <div className="flex flex-col">
        ...
        <div className="flex flex-col">
          ...
          <h5 className="text-[11px] hover:underline mb-1">Help Center</h5>
          <h5 className="text-[11px] hover:underline mb-1">Report a Product</h5>
          <h5 className="text-[11px] hover:underline mb-1">
      ...
      <div className="flex flex-col">
        ...
        <div className="flex flex-col">
          ...
          <h5 className="text-[11px] hover:underline mb-1">Official Stores</h5>
